...
reconstruct_file_path = os.path.join(save_folder, "reconstruct_{}.npy".format(save_date))
...
with open(reconstruct_file_path, 'wb') as f:
    np.save(f, {'m': reconstruct_meta_data, 'd': reconstruct_data}, allow_pickle=True)
...
print("Created ", reconstruct_file_path)
